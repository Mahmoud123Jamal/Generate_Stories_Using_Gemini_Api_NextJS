        ...
        <section className="relative py-20 overflow-hidden bg-orange-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We believe everyone has a story to tell. Our platform combines
              human creativity with cutting-edge artificial intelligence to turn
              simple ideas into immersive adventures.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 text-left">
              ...
              <p className="text-gray-400 text-lg mb-6 leading-relaxed">
                ...
                where imagination flourishes. Whether you are a parent creating
                a unique bedtime story for your child or a writer looking for a
